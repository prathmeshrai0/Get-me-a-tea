...
const Login = () => {
  ...
  useEffect(() => {
    document.title = "Login - Get Me A Tea"
    if (session) {
            ...
            <div className="   w-3/4 mx-auto flex flex-col items-center  gap-3  text-center  ">
              ...
              <div className="flex flex-col gap-2     p-10">
                <button
                 onClick={() => {
                    signIn('google');
                  }}className="flex cursor-pointer items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                  <svg
